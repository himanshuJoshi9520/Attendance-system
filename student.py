...
class Student:
    def __init__(self, root):
        ...
        img = Image.open(r"E:\ing\iStock-classroom-girls-students-school.jpg")
        ...
        title_lbl = Label(bg_img, text="STUDENT MANAGENMENT SYSTEM", font=("times new roman", 35, "bold"), bg="black", fg="white")
...
# Course
  ...
  #-------------------function decleration----------------------
    ...
    def add_data(self):  # Check the indentation of this line
