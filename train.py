...
class Train:
    def __init__(self, root):
        ...
        img_top = Image.open(r"E:\ing\download (5).jpeg")
        ...
        # button
        b1_1=Button(self.root,text="TRAIN DATA",command=self.train_classifier,cursor="hand2",font=("times new roman", 25, "bold"), bg="black", fg="white")
        b1_1.place(x=0,y=380,width=1530,height=60)
        
        img_bottom = Image.open(r"E:\ing\images (5).jpeg")
