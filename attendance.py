...
class Attendance:
    def __init__(self, root):
        ...
        # 1st image
        img_top = Image.open(r"E:\ing\images (7).jpeg")
        img_top = img_top.resize((800, 200))
        self.photoimg_top = ImageTk.PhotoImage(img_top)
        f_lbl = Label(self.root, image=self.photoimg_top)
        f_lbl.place(x=0, y=0, width=800, height=200)

        # 2nd image
        img_bottom = Image.open(r"E:\ing\images (8).jpeg")
        img_bottom = img_bottom.resize((800, 200))
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)
        f_lbl = Label(self.root, image=self.photoimg_bottom)
        f_lbl.place(x=800, y=0, width=800, height=200)

        img3 = Image.open(r"E:\ing\download (3).jpeg")
        ...
        main_frame.place(x=10, y=78, width=1500, height=650)
        ...
        img_left = Image.open(r"E:\ing\download (3).jpeg")
        img_left = img_left.resize((720, 130))
        self.photoimg_left = ImageTk.PhotoImage(img_left)
        f_lbl = Label(Left_frame, image=self.photoimg_left)
        f_lbl.place(x=5, y=0, width=720, height=130)

        left_inside_frame = LabelFrame(main_frame, bd=2, relief=RIDGE, text="Student Details", font=("times new roman", 12, "bold"))
        left_inside_frame.place(x=0, y=135, width=730, height=370)

        # Attendance ID
        attendanceId_label = ttk.Label(left_inside_frame, text="AttendanceId:", font=("times new roman", 13, "bold"), style="TLabel")
        ...
        # Name
        rollLabel = ttk.Label(left_inside_frame, text="Roll:", background="white", font="comicsansns 11 bold")
        ...
        # Date
        nameLabel = ttk.Label(left_inside_frame, text="Name:", background="white", font="comicsansns 11 bold")
        ...
        # Department
        depLabel = ttk.Label(left_inside_frame, text="Department:", background="white", font="comicsansns 11 bold")
        ...
        # Time
        timeLabel = ttk.Label(left_inside_frame, text="Time:", background="white", font="comicsansns 11 bold")
        ...
        # Date
        dateLabel = ttk.Label(left_inside_frame, text="Date:", background="white", font="comicsansns 11 bold")
        ...
        attendanceLabel = ttk.Label(left_inside_frame, text="Attendance Status", background="white", font="comicsansns 11 bold")
    ...
    def exportCsv(self):
      try:
          ...
          fin = filedialog.asksaveasfilename(initialdir=os.getcwd(), title="Save CSV", filetypes=(("CSV files", ".csv"), ("All files", ".*")), parent=self.root)
          ...
          messagebox.showinfo("Data Export", f"Your data exported to {os.path.basename(fin)} successfully")
